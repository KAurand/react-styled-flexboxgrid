(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('@emotion/styled'), require('@emotion/core'), require('lodash.isinteger')) :
  typeof define === 'function' && define.amd ? define(['exports', 'prop-types', '@emotion/styled', '@emotion/core', 'lodash.isinteger'], factory) :
  (global = global || self, factory(global['react-styled-flexboxgrid'] = {}, global.PropTypes, global.styled, global.core, global._.isInteger));
}(this, function (exports, PropTypes, styled, core, isInteger) { 'use strict';
  ...
  function makeMedia(media) {
    return function () {
      return core.css(_templateObject(), media, core.css.apply(void 0, arguments));
    };
  }
  ...
  var Grid = styled.div(_templateObject$1(), function (p) {
    ...
    return !p.fluid && core.css(_templateObject2(), DIMENSION_NAMES.map(function (t) {
